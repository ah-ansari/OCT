...
def growing_spheres_search(
    ...
    # Modified: no need for instance label
    ...
    while (not counterfactuals_found) and (count < max_iter):
        ...
        # Modified: apply clip to keep the generated CF examples between 0 and 1
        candidate_counterfactuals_continuous = np.clip(candidate_counterfactuals_continuous, a_min=0, a_max=1)
        ...
        # Modified: set target_class as 1
